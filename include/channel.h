 ...
 *
 * $Id: channel.h,v 1.1.1.1 2006/12/19 12:56:34 zipbreake Exp $
 */
...
#define CHFL_OWNER				0x4000
#define CHFL_HALFOP				0x8000

#define CHFL_OVERLAP         (CHFL_CHANOP | CHFL_VOICE | CHFL_OWNER | CHFL_HALFOP)
#define CHFL_BANVALIDMASK    (CHFL_BANVALID | CHFL_BANNED)
#define CHFL_VOICED_OR_OPPED (CHFL_CHANOP | CHFL_VOICE | CHFL_OWNER | CHFL_HALFOP)

/* Channel Visibility macros */

#define RHMODE_HALFOP		CHFL_HALFOP
#define RHMODE_OWNER		CHFL_OWNER
#define RHMODE_BADWORDS		0x0004
#define RHMODE_NOCOLOR		0x0008
#define RHMODE_RGSTRONLY	0x0010
#define RHMODE_REGISTERED	0x0020
#define RHMODE_AUTOOP		0x0040
#define RHMODE_ONLYIRCOP	0x0200
#define RHMODE_CHARLAS		0x0400
#define RHMODE_HASJOINP		0x0800
 ...
 */
#define MODE_WPARAS     (MODE_CHANOP|MODE_VOICE|MODE_BAN|MODE_KEY|MODE_LIMIT|RHMODE_OWNER|RHMODE_HALFOP)
...
#define IsChanHalfop(x)		((x)->status & CHFL_HALFOP)
...
struct Channel {
  ...
  struct Client      *founder;              /* Fundador del canal */
  char               chname[1];
};
...
struct ModeBuf {
  ...
  unsigned int		mb_rhadd;
  unsigned int		mb_rhrem;
  ...
  char *botmode_from;			/* Nick del botmode */
...
#define MODEBUF_BOTMODE		0x20000 /* Se ha recibido un botmode */
...
extern inline void channel_set_persistent_modes(struct Channel *chptr);
...
#define MODE_PARSE_NOTADD	0x100	/* Solo parsea el modo de usuario, pero no lo añade */
#define MODE_PARSE_HALFOP	0x200	/* Parsea teniendo en cuenta que el usuario solo tiene medio op */
...
#define BADWORDS_CHANNEL	 0x1
#define BADWORDS_QUERY		 0x2
#define BADWORDS_CHANPRIO	 0x4
#define BADWORDS_QUITMSG	 0x8
